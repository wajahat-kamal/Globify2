      ...
      <div className="max-w-7xl mx-auto md:mx-20 min-h-[600px] flex flex-col-reverse md:flex-row items-center justify-between text-center md:text-left py-14">
        ...
        <div className="w-full md:w-1/2 space-y-5 mt-8 md:mt-0 animate-slideLeft">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
            ...
            with{" "}
            <span className="text-indigo-600 relative inline-block after:absolute after:w-full after:h-1 after:bg-indigo-600 after:bottom-0 after:left-0 after:rounded-full">
              GLOBIFY
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0 mt-6 justify-center md:justify-start">
            <Link to="/dashboard">
              <button className="bg-indigo-600 text-white font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-indigo-600 transition-all duration-300 w-full sm:w-auto">
                Get Started
              </button>
            </Link>
            <Link to="/about">
              <button className="border border-indigo-600 text-indigo-600 font-semibold px-8 py-3 rounded-lg hover:bg-indigo-600 hover:text-white transition-all duration-300 w-full sm:w-auto">
                Learn More
              </button>
            </Link>
          </div>
        ...
        <div className="w-[85%] md:w-[45%] relative group animate-slideRight">
          ...
          <div className="absolute -z-10 top-6 left-6 w-full h-full rounded-xl bg-indigo-600 opacity-10 blur-2xl"></div>
        </div>
      </div>
    </div>
  );
