...
function LogoutPopup({ setShowLogoutPopup }) {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black/40 backdrop-blur-sm z-50">
      {/* Popup Card */}
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black md:mt-25 rounded-2xl shadow-2xl w-72 md:w-96 p-6 text-center border border-gray-700 scale-95 ">
